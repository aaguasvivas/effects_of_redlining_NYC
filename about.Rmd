...
graphs. Below I display the median income in 2018, as well as the racial geography of the five boroughs, from 2014-2018.
...
graph_Bronx_race <- Bronx_county %>%
  ...
  labs(title = "Racial geography of Bronx County, New York",
...
graph_Brooklyn_race <- Brooklyn_county %>%
  ...
  scale_fill_viridis_c(direction = -1) +
  scale_color_viridis_c(direction = -1) +
  labs(title = "Racial geography of Kings County, New York",
       caption = "Source: American Community Survey 2014-2018") +
  theme_void()
