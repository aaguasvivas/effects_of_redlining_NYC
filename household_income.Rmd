...
bronx_data1950 <- read.csv("raw-data/householdincomedata/1950/nhgis0009_csv/nhgis0009_ds82_1950_tract.csv")%>%
  filter(STATE == "New York" & B0F001 > 0) %>%
  mutate(MedianHHIncome1949 = B0F001) %>%
  select(GISJOIN,MedianHHIncome1949)
...
bronx_tracts1950 <- sf::st_read(dsn = 
                            "raw-data/householdincomedata/1950/nhgis0009_shape/nhgis0009_shapefile_tl2008_us_tract_1950/",
                         layer = "US_tract_1950_conflated")
...
bronx_household_income_1960 <- tracts1960Print %>%
  filter(STATE == "New York" & COUNTYA == "5" & !is.na(MedianIncome)) %>%
  select(GISJOIN, MedianIncome)

bronx_1960_map <- sf::st_read(dsn = "raw-data/householdincomedata/1960/nhgis0010_shape/nhgis0010_shapefile_tl2008_us_tract_1960/",
                        layer = "US_tract_1960_conflated")
...
bronx_1970_map <- sf::st_read(dsn = "raw-data/householdincomedata/1970/nhgis0011_shape/nhgis0011_shapefile_tl2008_us_tract_1970/",
                        layer = "US_tract_1970_conflated")
