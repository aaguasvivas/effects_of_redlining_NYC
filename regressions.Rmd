...
tables_combined <- inner_join(x = HouseholdIncome1950, y = HousingValue1950, by = c("GISJOIN", "STATE", "COUNTYA"))

final_join_bronx_1950 <- inner_join(x = tables_combined, y = RaceData1950, 
...
tables_combined <- inner_join(x = HouseholdIncome1960, y = HousingValue1960, by = c("GISJOIN", "STATE", "COUNTYA"))

tables_combined

final_join_bronx_1960 <- inner_join(x = tables_combined, y = RaceData1960, 
                         by = c("GISJOIN", "STATE", "COUNTYA")) %>%
  filter(COUNTYA == "5") %>%
  mutate(TotalPop = White + Black + OtherNonWhite, 
         WhitePct = White/TotalPop*100, 
...
tables_combined <- inner_join(x = HouseholdIncome1970, y = HousingValue1970, 
                              by = c("GISJOIN", "STATE", "COUNTYA"))

tables_combined

final_join_bronx_1970 <- inner_join(x = tables_combined, y = RaceData1970, 
                         by = c("GISJOIN", "STATE", "COUNTYA")) %>%
  filter(COUNTYA == "5") %>%
  mutate(TotalPop = White + Black + OtherNonWhite, 
         WhitePct = White/TotalPop*100, 
...
tables_combined <- inner_join(x = HouseholdIncome1980, y = HousingValue1980, 
                              by = c("GISJOIN", "STATE", "COUNTYA"))

tables_combined

final_join_bronx_1980 <- inner_join(x = tables_combined, y = RaceData1980, 
                         by = c("GISJOIN", "STATE", "COUNTYA")) %>%
  filter(COUNTYA == "5") %>%
...
tables_combined <- inner_join(x = HouseholdIncome1990, y = HousingValue1990, 
                              by = c("GISJOIN", "STATE", "COUNTYA"))

tables_combined

final_join_bronx_1990 <- inner_join(x = tables_combined, y = RaceData1990, 
                         by = c("GISJOIN", "STATE", "COUNTYA")) %>%
  filter(COUNTYA == "5") %>%
