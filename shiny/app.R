...
tabPanel("Background Information",
         column(8,
             ...
             h4("- Redlining is the racist and discriminatory systematic denial of various services by federal government agencies, local government, mortgage lenders and the private sector, especially the denial of housing and business loans, to communities of colors, based simply on race and ethnicity, directly or through the selective raising of prices. Neighborhoods of color, with high percentages of Black, Latinx and other minority groups are more likely to be redlined compared to majority-white neighborhoods, regardless of income. Not only have there been a denial of loans, but also housing insurance, health care and even supermarkets to communities of color. As a result of redlining, white residents move from urban to surburban areas, buy houses and start businesses with the loans they acquire, and drive the wealth away from these urban communities, creating a wealth gap, that only increases over time as residents of color are unable to accumulate wealth, unlike the White residents. This story of discrimination is not as simple as saying that these maps were the only factor in creating the racial wealth gap, as there were many other racist and discriminatory policies that only continued to exasperate the consequences of redlining, many of which existed even before redlining due to America's complicated history with race, slavery, Jim Crow and more. Following the passage of the 1968 Fair Housing Act, racist housing policy survived the abolition of redlining. A 'fair housing' for-profit model was adopted, and very few government and insurance agencies were willing to help and invest in the Black community, due to the racist rhetoric/language associated with them, regardless of education, income or social status. In their book, Race for Profit: How Banks and the Real Estate Industry Undermined Black Homeownership, Keeanga-Yamahtta Taylor describes that, “a bootlegger,” brothel owner, gangster, and “a colored man of means” all presented the same kind of threat to a neighborhood’s civic and economic health (40). If you want to learn more details about redlining, be sure to visit the sources outlined below!"),
             h3("Sources Used: "),
